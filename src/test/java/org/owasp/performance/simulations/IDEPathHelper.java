...
public class IDEPathHelper {
  ...
  static {
    try {
      ...
      Path mavenSrcDirectory = projectRootDir.resolve("src").resolve("test");

      mavenSourcesDirectory = mavenSrcDirectory.resolve("java");
      mavenResourcesDirectory = mavenSrcDirectory.resolve("resources");
      mavenBinariesDirectory = mavenTargetDirectory.resolve("classes").resolve("java").resolve("gatling");
      resultsDirectory = mavenTargetDirectory.resolve("reports").resolve("gatling");
